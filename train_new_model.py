...
def main(args):
    ...
    #这里我们把所有的csv数据都当作训练集
    #train_set=utils._get_dataset(args.csv_exp)
    train_set=utils.__get_dataset(args.file_exp)[0:17]
    ...
    if args.lfw_dir:
        ...
        lfw_paths, actual_issame = face_net_test.read_pairs(args.pairs_path)
...
def parse_arguments(argv):
    ...
    parser.add_argument('--models_base_dir', type=str,
                        help='Directory where to write trained models and checkpoints.', default='~/kiwi_fung/label_web/models/facenet_cow')
    '''
